...
public class Bluetooth {
    ...
    /**
     * Message displayed when the Bluetooth discovery failed to start.
     */
    private static final String BLUETOOTH_DISCOVERY_FAILED = "Unable to start Bluetooth discovery";
